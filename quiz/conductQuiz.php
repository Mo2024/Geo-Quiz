...
<form id="quizForm" class="validated-form mt-3" method="POST" action="<?php echo '/ITCS333-Project/controllers/quiz/submitQuiz.inc.php?quizId='.$quizRow['quizid'] ?>" novalidate>
